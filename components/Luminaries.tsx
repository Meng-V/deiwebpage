        ...
        <div className="mx-auto">
          ...
          <div className="mt-4">
            <p>
              ...
              increase representation in library and information sciences
              careers among historically underrepresented populations.{" "}
            </p>
            <p>
              Through paid, resume-building student employment and support from
              a mentor, Luminaries gain a broad introduction to the library and
              ...
              participant’s decision to pursue a career in Library and
              Information Science; the hands-on training and networking
              opportunities bolster Luminaries’ abilities to establish their
              careers.{" "}
            </p>
            <p>
              Miami University Libraries joined the OhioLINK Luminaries program
              in 2021. Read about the experience of one of the inaugural
              students, Hal Howard, in{" "}
